...
public class King extends ChessPiece {
    ...
    // Método auxiliar para testar se a Torre para o roque está na posição correta e pode se mover
    ...
    public boolean[][] possibleMoves() {
        ...
        // Só é permitido fazer roque se o Rei nunca se moveu e não estiver em xeque
